...
{
    public class RsaEncryptionStatic2 {
        private RSACryptoServiceProvider csp;
        private RSAParameters _privateKey;
        private RSAParameters _publicKey;

        public RsaEncryptionStatic2() {
            // RSAParameters privKey, RSAParameters pubKey
            //poder establecer valores para los parametros desde fuera
            // _privateKey = privKey;
            // _publicKey = pubKey;
    ...
    public class Test2{
        public static void Main() {
            ...
            RsaEncryptionStatic2 rsa2 = new RsaEncryptionStatic2();
            ...
            var pubKey = RsaEncryptionStatic2.PublicParametersFromXml(pubKeyStr);
            var privKey = RsaEncryptionStatic2.PublicParametersFromXml(privKeyStr);
