...
begin
	return (select count(*) from Socios);
end
$$
DELIMITER ;
...
DELIMITER $$
create function F02(SaldoExterno real) returns int
begin
	return (select count(*) from Socios where Saldo < SaldoExterno);
end
$$
DELIMITER ;
...
drop function if exists FIncrementar;
DELIMITER $$
create function FIncrementar(num int) returns int
begin
	return (num + 1);
end
$$
DELIMITER ;
/*
select FIncrementar(5);

*/
drop function if exists FSuma;
DELIMITER $$
create function FSuma(num1 int, num2 int) returns int
begin
	declare i int;
    declare resultado int default 0;
    set i = 0;
    while (i < num2) do
		set resultado = FIncrementar(num1 + i);
        set i = i + 1;
	end while;
    return resultado;
end
...
drop function if exists FMultiplicacion;
DELIMITER $$
create function FMultiplicacion(num1 int, num2 int) returns int
begin
	declare i int;
    declare resultado int default 0;
    set i = 0;
    while (i < num2) do
		set resultado = FSuma(resultado,num1);
        set i = i + 1;
	end while;
    return resultado;
end
...
/*select FMultiplicacion(3,4);*/

drop function if exists FPotencia;
DELIMITER $$
create function FPotencia(num1 int, num2 int) returns int
begin
	declare i int;
    declare resultado int default 1;
    set i = 0;
    while (i < num2) do
		set resultado = FMultiplicacion(resultado,num1);
        set i = i + 1;
	end while;
    return resultado;
end
...
/*select FPotencia(2,3);*/


drop function if exists FDecrementar;
DELIMITER $$
create function FDecrementar(num int) returns int
begin
	return (num - 1);
end
$$
...
/*select FDecrementar(5);*/

drop function if exists FResta;
DELIMITER $$
create function FResta(num1 int, num2 int) returns int
begin
	declare i int;
    declare resultado int default num1;
    set i = 0;
    while (i < num2) do
		set resultado = FDecrementar(resultado);
        set i = i + 1;
	end while;
    return resultado;
end
...
drop function if exists FDivision;
DELIMITER $$
create function FDivision(num1 int, num2 int) returns int
begin
    declare resultado int default 0;
