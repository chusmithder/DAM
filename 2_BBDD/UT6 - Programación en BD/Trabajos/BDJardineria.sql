DROP DATABASE IF EXISTS	bdJardineria;
CREATE DATABASE bdJardineria;
USE bdJardineria;
...
INSERT INTO Oficinas VALUES ('LOG-ES', 'Logroño', 'España', 'La Rioja', '26140', '+34 941 22 22 22', 'Avenida de la Solidaridad 25', 'Bajo');
...
CREATE TABLE Empleados (
  ...
  CONSTRAINT Empleados_OficinasFK FOREIGN KEY (CodigoOficina) REFERENCES Oficinas (CodigoOficina) on delete cascade on update cascade,
  CONSTRAINT Empleados_EmpleadosFK FOREIGN KEY (CodigoJefe) REFERENCES Empleados (CodigoEmpleado) on delete cascade on update cascade
) engine=innodb;

/*Inserciones Empleados*/
INSERT INTO Empleados VALUES (1,'Marcos','Magaña','Perez','3897','marcos@jardineria.es','TAL-ES',NULL,'Director General',5000);
INSERT INTO Empleados VALUES (2,'Ruben','López','Martinez','2899','rlopez@jardineria.es','TAL-ES',1,'Subdirector Marketing',4500);
INSERT INTO Empleados VALUES (3,'Alberto','Soria','Carrasco','2837','asoria@jardineria.es','TAL-ES',2,'Subdirector Ventas',4500);
INSERT INTO Empleados VALUES (4,'Maria','Solís','Jerez','2847','msolis@jardineria.es','TAL-ES',2,'Secretaria',2000);
INSERT INTO Empleados VALUES (5,'Felipe','Rosas','Marquez','2844','frosas@jardineria.es','TAL-ES',3,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (6,'Juan Carlos','Ortiz','Serrano','2845','cortiz@jardineria.es','TAL-ES',3,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (7,'Carlos','Soria','Jimenez','2444','csoria@jardineria.es','MAD-ES',3,'Director Oficina',1500);
INSERT INTO Empleados VALUES (8,'Mariano','López','Murcia','2442','mlopez@jardineria.es','MAD-ES',7,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (9,'Lucio','Campoamor','Martín','2442','lcampoamor@jardineria.es','MAD-ES',7,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (10,'Hilario','Rodriguez','Huertas','2444','hrodriguez@jardineria.es','MAD-ES',7,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (11,'Emmanuel','Magaña','Perez','2518','manu@jardineria.es','BCN-ES',3,'Director Oficina',3560);
INSERT INTO Empleados VALUES (12,'José Manuel','Martinez','De la Osa','2519','jmmart@hotmail.es','BCN-ES',11,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (13,'David','Palma','Aceituno','2519','dpalma@jardineria.es','BCN-ES',11,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (14,'Oscar','Palma','Aceituno','2519','opalma@jardineria.es','BCN-ES',11,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (15,'Francois','Fignon','','9981','ffignon@gardening.com','PAR-FR',3,'Director Oficina',3560);
INSERT INTO Empleados VALUES (16,'Lionel','Narvaez','','9982','lnarvaez@gardening.com','PAR-FR',15,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (17,'Laurent','Serra','','9982','lserra@gardening.com','PAR-FR',15,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (18,'Michael','Bolton','','7454','mbolton@gardening.com','SFC-USA',3,'Director Oficina',3560);
INSERT INTO Empleados VALUES (19,'Walter Santiago','Sanchez','Lopez','7454','wssanchez@gardening.com','SFC-USA',18,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (20,'Hilary','Washington','','7565','hwashington@gardening.com','BOS-USA',3,'Director Oficina',3560);
INSERT INTO Empleados VALUES (21,'Marcus','Paxton','','7565','mpaxton@gardening.com','BOS-USA',20,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (22,'Lorena','Paxton','','7665','lpaxton@gardening.com','BOS-USA',20,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (23,'Nei','Nishikori','','8734','nnishikori@gardening.com','TOK-JP',3,'Director Oficina',3560);
INSERT INTO Empleados VALUES (24,'Narumi','Riko','','8734','nriko@gardening.com','TOK-JP',23,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (25,'Takuma','Nomura','','8735','tnomura@gardening.com','TOK-JP',23,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (26,'Amy','Johnson','','3321','ajohnson@gardening.com','LON-UK',3,'Director Oficina',3560);
INSERT INTO Empleados VALUES (27,'Larry','Westfalls','','3322','lwestfalls@gardening.com','LON-UK',26,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (28,'John','Walton','','3322','jwalton@gardening.com','LON-UK',26,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (29,'Kevin','Fallmer','','3210','kfalmer@gardening.com','SYD-AU',3,'Director Oficina',3560);
INSERT INTO Empleados VALUES (30,'Julian','Bellinelli','','3211','jbellinelli@gardening.com','SYD-AU',29,'Representante Ventas',1500);
INSERT INTO Empleados VALUES (31,'Mariko','Kishi','','3211','mkishi@gardening.com','SYD-AU',29,'Representante Ventas',1500);
...
CREATE TABLE Clientes (
  ...
  CONSTRAINT Clientes_EmpleadosFK FOREIGN KEY (CodigoEmpleadoRepVentas) REFERENCES Empleados (CodigoEmpleado) on delete cascade on update cascade 
) engine=innodb;
...
CREATE TABLE Pedidos (
  ...
  CONSTRAINT Pedidos_Cliente FOREIGN KEY (CodigoCliente) REFERENCES Clientes (CodigoCliente) on delete cascade on update cascade
) engine=innodb;
...
CREATE TABLE DetallePedidos (
  ...
  CONSTRAINT DetallePedidos_PedidoFK FOREIGN KEY (CodigoPedido) REFERENCES Pedidos (CodigoPedido) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT DetallePedidos_ProductoFK FOREIGN KEY (CodigoProducto) REFERENCES Productos (CodigoProducto) ON DELETE CASCADE ON UPDATE CASCADE
)engine=innodb;

/*Inserciones DetallePedidos*/
...
-- OFICINAS(CodigoOficina,Ciudad,Pais,Region)

-- ej 1
drop procedure if exists clientePais;
DELIMITER $$
create procedure clientePais(in pNombrePais varchar(20))
begin
...
DELIMITER $$
create procedure pagoMaximo(in pFormaPago varchar(20))
begin
select NombreCliente, Ciudad, Pais
	from Clientes
    where Pais in 
