...
DELIMITER $$
create procedure Ejemplo(in cuantasBlandas int,
							cuantosAlquileres int,
...
begin
    ...
    set Salida = concat("El saldo medio de los socios que han alquilado al menos ",
						cuantosAlquileres, " libros que tienen como mínimo ",
                        cuantasBlandas, " tapas blandas  es de ",saldoMedio, 
