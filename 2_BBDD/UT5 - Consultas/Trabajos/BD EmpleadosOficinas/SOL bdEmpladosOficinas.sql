...
-- EJERCICIOS --------------------------------------------------------------------------------
-- 2.2 BD "bdEmpleadosOficinas"
	-- 2.2.1 Repaso constultas sobre una sola tabla
		-- 3
select Nombre, year(curdate()) - Edad , timestampdiff(day, Contrato, curdate())
	from empleados;
...
select * 
	...
	-- 2.2.2 Consultas INNER, JOIN, LEFT, JOIN y otros


-- CUANDO HAY CLAVE COMPUESTA ON ... = ... AND ... = ... (HACER JOIN)
